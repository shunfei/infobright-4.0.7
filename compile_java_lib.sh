...
BHROOT=${ROOT_DIR}/src/storage/brighthouse
LIBDIR=${ROOT_DIR}/java_lib
mkdir -p ${LIBDIR}
...
if [[ "${OSTYPE}" == "linux"* ]] || [[ "${OSTYPE}" == "cygwin"* ]]; then
    ...
    BOOST_SYSTEM_LIB=libboost_system.dylib
else
...
g++ -shared -fPIC -O3 -o ${LIBDIR}/${BHLIB} ${CPP_OUT_DIR}/*.o -lboost_system
